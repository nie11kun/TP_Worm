...
with open("output.txt", "w", encoding="utf-8") as f:
    ...
    for val in step_values:
        ...
        f.write(f"{label}:\n")
        f.write(";基准圆心坐标\n")
        f.write(f"R221={center_x:8.4f}       ;X坐标\n")
        f.write(f"R222={center_z:8.4f}        ;Z坐标\n")
        f.write(f"R223={center_r:8.4f}        ;圆弧半径\n")
        f.write(";============\n")
        f.write(";磨削起点坐标\n")
        f.write(f"R231={start_x:8.4f}        ;X坐标\n")
        f.write(f"R232={start_z:8.4f}        ;Z坐标\n")
        f.write(f"R233={start_b:8.4f}        ;B绝对角度\n")
        f.write(f"R234={start_c:8.4f}        ;C绝对角度\n")
        f.write(";============\n")
        f.write(";磨削终点坐标\n")
        f.write(f"R241={end_x:8.4f}        ;X坐标\n")
        f.write(f"R242={end_z:8.4f}       ;Z坐标\n")
        f.write(f"R243={end_b:8.4f}        ;B绝对角度\n")
        f.write(f"R244={end_c:8.4f}      ;C轴终端增量角度\n\n")
        f.write("RET\n\n")
